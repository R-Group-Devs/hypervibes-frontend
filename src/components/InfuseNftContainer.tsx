...
import hyperVibesLogoPatternVertical from '../assets/images/infuse-nft-border-pattern-vertical.png';
import hyperVibesLogoPatternHorizontal from '../assets/images/infuse-nft-border-pattern-horizontal.png';
...
const BackgroundContainerVertical = styled.div`
  position: relative;
  padding-left: 3em;
  background: url(${hyperVibesLogoPatternVertical}) left bottom no-repeat;
...
const BackgroundContainerHorizontal = styled.div`
  padding-bottom: 3em;
  margin-left: -3em;
  background: url(${hyperVibesLogoPatternHorizontal}) left bottom no-repeat;
